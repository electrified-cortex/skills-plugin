#Requires -Version 7
# create.ps1 — Create a GitHub issue via gh issue create.
...
# ---------------------------------------------------------------------------
# Invoke gh issue create via ProcessStartInfo (no command-string interpolation)
# ---------------------------------------------------------------------------
...
[Console]::Out.WriteLine($issueUrl)
